...
library(shiny)
library(bslib)
library(surveyjoin) #devtools::install_github("DFO-NOAA-Pacific/surveyjoin")
library(sdmTMB)
...
ui <- page_sidebar(
  ...
  sidebar = tagList(
    conditionalPanel(
      # default sidebar for most tabs
      condition = "input.tabs != 'Home'",
      div(
        "A tool to visualize data from NOAA and DFO surveys.",
    ...
    conditionalPanel(
      # Home tab sidebar : no selections
      condition = "input.tabs == 'Home'",
      div(
        "A tool to visualize data from NOAA and DFO scientific surveys.",
        style = "font-size:16px; color:black;"
      ),
      div(
    ...
    conditionalPanel(
      # additional selection menus for ALL REGIONS BIOMASS
    ...
    conditionalPanel(
      # additional selection menus for AK BSAI BIOMASS
    ...
    conditionalPanel(
      # additional selection menus for CANADA BIOMASS
  ...
  tabsetPanel(
    ...
    tabPanel(
      ...
      card(
        ...
        card_body(
          tags$p(
            "This interactive app serves as a coastwide synopsis for groundfish in the northeast Pacific Ocean,
      ...
      card(
        ...
        card_body(
          tags$p(
            "Our data come from",
            tags$strong("fishery-independent trawl surveys "),
            "conducted by the ",
            tags$strong(
              "National Oceanic and Atmospheric Administration (NOAA) "
            ),
            "and ",
            tags$strong("Fisheries and Oceans Canada (DFO)"),
            ", compiled from NOAA's Alaska Fisheries Science Center (AFSC) and Northwest Fisheries Science Center (NWFSC), and DFO's Pacific Biological Station (PBS).
          ...
          tags$div(
            tags$strong("Aleutians/Bering Sea (AFSC):"),
            tags$br(),
            tags$div(style = "margin-left: 1em;", "Aleutian Islands"),
            tags$div(
              style = "margin-left: 1em;",
              "U.S. Eastern Bering Sea Slope"
            ),
            tags$div(
              style = "margin-left: 1em;",
            ...
            tags$br(),
            tags$strong("Gulf of Alaska (AFSC):"),
            tags$br(),
            tags$div(style = "margin-left: 1em;", "Gulf of Alaska"),
            tags$br(),
            tags$strong("Canada (PBS):"),
            tags$br(),
            tags$div(
              style = "margin-left: 1em;",
            ...
            tags$div(
              style = "margin-left: 1em;",
              "Synoptic West Coast Vancouver Island (SYN WCHG)"
            ),
            tags$div(
              style = "margin-left: 1em;",
              "Synoptic West Coast Haida Gwaii (SYN WCVI)"
            ),
            tags$br(),
            tags$strong("US West Coast (NWFSC):"),
            tags$br(),
      ...
      card(
        ...
        card_body(
          tags$p(
            "This app uses plotting functions from the ",
            tags$a(
              href = "https://doi.org/10.5281/zenodo.15932836",
              "fishyplots",
              target = "_blank"
            ),
            ...
            tags$a(
              href = "https://github.com/pbs-assess/gfsynopsis",
              "BC Groundfish Data Synopsis Report",
              target = "_blank"
            ),
            " and builds off an ",
            tags$a(
              href = "https://github.com/DFO-NOAA-Pacific/gfsynopsis-noaa",
              "initial version",
              target = "_blank"
            ),
            " from 2024."
      ...
      card(
        ...
        card_body(
          tags$p(
            "Have a question or found a bug? Please ",
            HTML(
              ' <a href = "https://github.com/DFO-NOAA-Pacific/shinyfishyplots/issues" target = "_blank" >report here</a>.'
            )
          )
        )
      ),
      card(
        ...
        card_body(
          ...
          tags$ul(tags$li(
            "Von Szalay PG, Raring NW, Siple MC, Dowlin AN, Riggle BC, and Laman EA. 2023. Data Report: 2022 Aleutian Islands bottom trawl survey. U.S. Dep. Commer. DOI: ",
            tags$a(
              "10.25923/85cy-g225",
          ...
          tags$ul(tags$li(
            "Siple MC, von Szalay PG, Raring NW, Dowlin AN, Riggle BC. 2024. Data Report: 2023 Gulf of Alaska bottom trawl survey. DOI: ",
            tags$a(
              "10.25923/GBB1-X748",
          ...
          tags$strong(
            "Eastern & Northern Bering Sea Crab/Groundfish Bottom Trawl Surveys"
          ),
          tags$ul(
            tags$li(
          ...
          tags$ul(
            tags$li(
              "Hoff GR. 2016. Results of the 2016 eastern Bering Sea upper continental slope survey of groundfishes and invertebrate resources. U.S. Dep. Commer. DOI: ",
              tags$a(
                "10.7289/V5/TM-AFSC-339",
          ...
          tags$strong(
            "Fisheries and Oceans Canada Synoptic Bottom Trawl Surveys"
          ),
          tags$ul(
            tags$li(
              "Anderson SC, Keppel EA, Edwards AM. 2019. ",
              HTML(
                '<a href="https://www.dfo-mpo.gc.ca/csas-sccs/Publications/ResDocs-DocRech/2019/2019_041-eng.html" target="_blank">
       A reproducible data synopsis for over 100 species of British Columbia groundfish</a>.'
            ...
            tags$li(HTML(
              "Nottingham MK, Williams DC, Wyeth MR, Olsen N. 2017. <a href='https://publications.gc.ca/site/eng/9.848701/publication.html' target='_blank'>Summary of the West Coast Vancouver Island synoptic bottom trawl survey, May 28 – June 21, 2014</a>. DFO Can. Manuscr. Rep. Fish. Aquat. Sci. 2017/3140, viii + 55 p, Nanaimo."
            )),
            tags$li(
          ...
          tags$ul(
            tags$li(
              "Keller AA, Wallace JR, Methot RD. 2017. The Northwest Fisheries Science Center's West Coast Groundfish Bottom Trawl Survey: history, design, and description. DOI: ",
              tags$a(
                "10.7289/V5/TM-NWFSC-136",
    ...
    tabPanel(
      "Biomass",
      conditionalPanel(
        #only show card when all regions selected
          ...
          accordion_panel(
            ...
            card_body(
              tags$p(
                ...
                actionLink(
                  "go_home_1",
                  "'About the Data' in the 'Home' tab",
                  style = "color: #2C3E79; text-decoration: underline;"
                ),
      ...
      conditionalPanel(
        ...
        accordion(
          ...
          accordion_panel(
            title = "Design-Based Biomass Indices",
            card_body(tags$div(
              "These biomass indices are design-based and may be calculated differently among science centers.",
      ...
      downloadButton(
        "downloadStanBiomass",
        "Download Standardized Biomass Plot"
      )
    ),
    ...
    tabPanel(
      ...
      withSpinner(
        ...
        size = 2,
        color.background = "#FFFFFFD0"
      ), #object containing all plots
      card(
        full_screen = FALSE,
        card_header("Model Info", style = "background-color: #d7d7d7;"),
        card_body(
          tags$div(tags$strong("Growth:"), "Von-Bertalanffy growth curve"),
          tags$div(tags$strong("Length-Weight:"), "Log-log regression"),
          tags$div(
            "See 'Data' tab to download biological and prediction datasets used in these plots."
          )
        )
      ),
    ...
    tabPanel(
      ...
      accordion(
        ...
        accordion_panel(
          ...
          card_body(
            tags$p(
              "Maps were made using land data from ",
              HTML(
                ' <a href = "https://doi.org/10.32614/CRAN.package.rnaturalearth" target = "_blank" >rnaturalearth</a>.'
              ),
    ...
    tabPanel(
      ...
      accordion(
        ...
        accordion_panel(
          ...
          card_body(
            "These plots display the number of biological measurements taken and tow effort for selected regions and species. 'Unread Ages' are the number of fishes with age structures collected but not analysed. For unrounded counts, use the data download below. "
          )
        )
      ),
      div(
        style = "overflow-x: scroll; min-width: 1200px;", #scrollable window
        withSpinner(
      ...
      downloadButton(
        "downloadSurveyTibble",
        "Download Survey Plot Data (Unrounded Counts)"
      ),
      tags$div(Style = "margin-top: 50px;"),
      card(
        full_screen = FALSE,
        card_header(
          "Data download options for selected region and species",
          style = "background-color: #d7d7d7;"
        )
      ),
...
server <- function(input, output, session) {
  ...
  region_names <- reactive({
    switch(
      ...
      "US West Coast" = "NWFSC",
      "Canada" = "PBS",
      "Aleutians/Bering Sea" = "AK BSAI",
      "Gulf of Alaska" = "AK GULF",
      "All regions" = c("AK BSAI", "AK GULF", "PBS", "NWFSC")
    )
  })
  ...
  vb_subset <- reactive({
    subset(
      vb_predictions,
      common_name == input$species & survey %in% region_names()
    )
  })
  map_subset <- reactive({
    ...
    subset(
      predictions,
      species == input$species & subregion %in% region_names()
    )
  })
  lw_subset <- reactive({
    subset(
  ...
  dbi_subset <- reactive({
    subset(
      all_dbi,
      common_name == input$species & survey_group %in% region_names()
    )
  })
  ...
  output$dynamicMap <- renderUI({
    validate(
      ...
      need(
        input$species != "" && input$species != "None selected",
  ...
  output$downloadMapPlot <- downloadHandler(
    filename = function() {
      paste0("map_", input$species, ".png")
    },
    content = function(file) {
      ggsave(
        file,
        plot = fishmap(predictions, region_names(), input$species),
        height = map_height2(),
        device = "png"
      )
    }
  ...
  output$dynamic_agelength <- renderUI({
    width <- if (
      identical(region_names(), c("AK BSAI", "AK GULF", "PBS", "NWFSC"))
    ) {
      "100%"
    } else {
      "65%"
  ...
  output$downloadGrowth <- downloadHandler(
    filename = function() {
      paste0("growth_plot_", input$species, ".png")
    },
    content = function(file) {
      ggsave(
        file,
        plot = plot_growth(all_data, region_names(), input$species),
        width = plot_width(),
        device = "png"
      )
    }
  ...
  output$downloadLW <- downloadHandler(
    filename = function() {
      paste0("lw_plot_", input$species, ".png")
    },
    content = function(file) {
      ggsave(
        file,
  ...
  output$downloadLTS <- downloadHandler(
    filename = function() {
      paste0("avglengths_plot_", input$species, ".png")
    },
    content = function(file) {
      ggsave(
        file,
        plot = length_ts(all_data, region_names(), input$species),
        width = plot_width(),
        device = "png"
      )
    }
  ...
  output$downloadAgeFreq <- downloadHandler(
    filename = function() {
      paste0("agefrequency_plot_", input$species, ".png")
    },
    content = function(file) {
      ggsave(
        file,
  ...
  output$downloadLengthFreq <- downloadHandler(
    filename = function() {
      paste0("lengthfrequency_plot_", input$species, ".png")
    },
    content = function(file) {
      ggsave(
        file,
        plot = length_frequency(
          all_data,
          region_names(),
          input$species,
          time_series = TRUE
  ...
  output$dynamic_depth <- renderUI({
    ...
    tagList(
      plotOutput("age_depthPlot", width = width, height = "600px"),
  ...
  output$downloadAgeDepthPlot <- downloadHandler(
    filename = function() {
      paste0("age_depth_plot_", input$species, ".png")
    },
    content = function(file) {
      ggsave(
        file,
        plot = plot_age_depth(all_data, region_names(), input$species),
        width = plot_width(),
        device = "png"
      )
    }
  ...
  output$downloadLengthDepthPlot <- downloadHandler(
    filename = function() {
      paste0("length_depth_plot_", input$species, ".png")
    },
    content = function(file) {
      ggsave(
        file,
        plot = plot_length_depth(all_data, region_names(), input$species),
        width = plot_width(),
        device = "png"
      )
    }
  ...
  output$dbiPlot <- renderPlot({
    if (input$region == "All regions") {
      # messages for no region or species
      validate(
        #message for none selected
        need(
          !is.null(input$surveys_selected) &&
            length(input$surveys_selected) > 0,
          "Choose survey(s)"
        ),
        need(
          input$species != "" && input$species != "None selected",
      ...
      if (length(invalid_dbi_surveys) > 0) {
        showNotification(
          paste(
            ...
            input$species,
            "in:",
            paste(invalid_dbi_surveys, collapse = ", ")
          ),
          type = "warning"
        )
      }
  ...
  observe(
    if (input$region == "All regions") {
      ...
      output$downloadStanBiomass <- downloadHandler(
        filename = function() {
          paste0("stan_biomass_plots_", input$species, ".png")
        },
        content = function(file) {
          ggsave(
            file,
            plot = plot_stan_dbi(input$species, valid_dbi_surveys),
            width = 10,
            device = "png"
          )
        }
      ...
      output$downloadBiomass <- downloadHandler(
        filename = function() {
          paste0("biomass_plot_", input$species, "_", region_names(), ".png")
        },
        content = function(file) {
          ggsave(
            file,
            plot = plot_dbi(input$species, input$surveys_selected),
            width = 10,
            device = "png"
          )
        }
      ...
      output$downloadStanBiomass <- downloadHandler(
        ...
        content = function(file) {
          ggsave(
            file,
            plot = plot_stan_dbi(input$species, input$surveys_selected),
            width = 10,
            device = "png"
          )
        }
      ...
      # not all regions, only one survey per region
      output$downloadBiomass <- downloadHandler(
        filename = function() {
          paste0("biomass_plot_", input$species, "_", region_names(), ".png")
        },
        content = function(file) {
          ggsave(
            file,
            plot = plot_dbi(input$species, region_names()),
            width = 10,
            device = "png"
          )
        }
      ...
      output$downloadStanBiomass <- downloadHandler(
        ...
        content = function(file) {
          ggsave(
            file,
            plot = plot_stan_dbi(input$species, region_names()),
            width = 10,
            device = "png"
          )
        }
  ...
  observeEvent(
    output$downloadSurveyTable <- downloadHandler(
      filename = function() {
        paste0("SurveyCount_plot_", input$species, ".png")
      },
      content = function(file) {
        ggsave(
          file,
    ...
    output$downloadSurveyTibble <- downloadHandler(
      filename = function() {
        paste0("SurveyCount_table_", input$species, ".csv")
      },
      content = function(file) {
        write.csv(
          survey_table(all_data, region_names(), input$species, form = 1),
          file
        )
      }
    )
